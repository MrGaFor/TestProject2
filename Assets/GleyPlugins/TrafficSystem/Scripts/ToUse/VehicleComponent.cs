...
namespace GleyTrafficSystem
{
    ...
    public class VehicleComponent : MonoBehaviour
    {
        ...
        public virtual void OnTriggerEnter(Collider other)
        {
            ...
            if(other.tag == "semaphore")
            {
                if (other.GetComponent<SemaphorePeople>().HOW_MANY > 0)
                {
                    StopDrive(other);
                }
            }
        ...
        public void StopDrive(Collider other)
        {
            int collidingVehicleIndex = -1;
            bool theySeeEachOther = false;
            //stop
        ...
        public void StartDrive(Collider other)
        {
            //go
        ...
        /// </summary>
        /// <param name="other"></param>
        public void NewColliderHit(Collider other)
        {
            isInTrigger = true;
